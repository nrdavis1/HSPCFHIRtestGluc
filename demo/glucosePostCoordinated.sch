...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Observation">
      <sch:assert test="count(f:extension[@url = 'http://hl7.org/fhir/hspc/StructureDefinition/reportingPriority']) &lt;= 1">extension with URL = 'http://hl7.org/fhir/hspc/StructureDefinition/reportingPriority': maximum cardinality of 'extension' is 1</sch:assert>
      ...
      <sch:assert test="count(f:extension[@url = 'http://hl7.org/fhir/hspc/StructureDefinition/glucoseChallenge']) &lt;= 1">extension with URL = 'http://hl7.org/fhir/hspc/StructureDefinition/glucoseChallenge': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'http://hl7.org/fhir/hspc/StructureDefinition/updateDateTime']) &lt;= 1">extension with URL = 'http://hl7.org/fhir/hspc/StructureDefinition/updateDateTime': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:modifierExtension) &lt;= 1">modifierExtension: maximum cardinality of 'modifierExtension' is 1</sch:assert>
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Observation/f:category">
      <sch:assert test="exists(f:coding/code[@value='laboratory']) and exists(f:coding/system[@value='http://hl7.org/fhir/observation-category'])">Must have a category of 'laboratory' and a code system 'http://hl7.org/fhir/observation-category' (inherited)</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
  ...
  <sch:pattern>
    <sch:title>Observation.valueQuantity.system</sch:title>
    <sch:rule context="f:Observation/f:valueQuantity/f:system">
      <sch:assert test="@value|f:*|h:div">All FHIR elements must have a @value or children (inherited)</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
    <sch:title>Observation.valueQuantity.code</sch:title>
    <sch:rule context="f:Observation/f:valueQuantity/f:code">
      <sch:assert test="@value|f:*|h:div">All FHIR elements must have a @value or children (inherited)</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
